...
public class Sanity {
	...
	public void homepagecontent() {
		...
		AssertJUnit.assertEquals(Heading1, heading1, "Heading1 are not equal");
		...
		AssertJUnit.assertEquals(Heading2, heading2, "Heading2 are not equal");
		...
		AssertJUnit.assertEquals(Heading3, heading3, "Heading3 are not equal");
		...
		AssertJUnit.assertEquals(actualParagraph, expectedParagraph, "Paragraphs are not equal");
		...
		AssertJUnit.assertEquals(Ncount1, Ncount, "Nissl are not equal");
		...
		AssertJUnit.assertEquals(Hcount1, Hcount, "HEOS are not equal");
		...
		AssertJUnit.assertEquals(Ncount2, Ncount_1, "Nissl are not equal");
		...
		AssertJUnit.assertEquals(Hcount2, Hcount_1, "HEOS are not equal");
		...
		AssertJUnit.assertEquals(Ncount3, Ncount_2, "Nissl are not equal");
		...
		AssertJUnit.assertEquals(Hcount3, Hcount_2, "HEOS are not equal");
		...
		AssertJUnit.assertEquals(Ncount5, Ncount_3, "Nissl are not equal");
		...
		AssertJUnit.assertEquals(Hcount4, Hcount_3, "HEOS are not equal");
		...
		AssertJUnit.assertEquals(Ncount6, Ncount_4, "Nissl are not equal");
		...
		AssertJUnit.assertEquals(Hcount5, Hcount_4, "HEOS are not equal");
